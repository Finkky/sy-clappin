...
public class ThrottlingSplitterTest {

	@ServiceOperation("ThrottlingSplitter" + ".process")
	private Invoker doSplit;

	@Test
	public void testBasic() {
		this.doSplit.sendInOnly(Lists.newArrayList(new FileDescriptorDTO("Hello"), "Hi", new FileDescriptorDTO("Ola")));
	}
}
